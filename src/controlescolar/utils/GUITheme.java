...
public class GUITheme {
	...
	private Border LIGHT_SHADOW_BORDER = new DropShadowBorder (Color.BLACK, 0, 4, 0.3f, 12, true, true, true, true);
    ...
    public Border getLIGHT_SHADOW_BORDER() {
        return LIGHT_SHADOW_BORDER;
    }
